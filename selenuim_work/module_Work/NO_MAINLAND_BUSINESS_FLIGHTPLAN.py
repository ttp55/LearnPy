...
def new_add_plan(d, plan_count):
    ...
    for i in range(plan_count):
        try:
            ...
            try:
                d.find_element_by_id('_easyui_combobox_i18_3').click()  # 点击选项
            except:
            ...
            d.execute_script("document.getElementById('EDATE_EN').value = '%sMAR25'" % random.randint(10, 30))
            # 调用JS直接给日期赋值
            d.find_element_by_id('POINT').send_keys('TEBAK')  # 入境点
            d.find_element_by_id('ROUTE').send_keys('TEBAK')  # 录入航路
            time.sleep(1)
            d.find_element_by_xpath('//*[@id="td0_ATTACHMENT"]/div/div[3]/div[2]/div').click()
            time.sleep(1)
            m.click(1000, 634)
            time.sleep(1)
            m.click(1200, 838)
            time.sleep(1)
            d.find_element_by_xpath('//*[@id="td0_ATTACHMENT"]/div/div[3]/div[2]/a').click()  # 点击upload

            d.find_element_by_xpath('//*[@id="td1_ATTACHMENT"]/div/div[3]/div[2]/div').click()
            time.sleep(1)
            m.click(1000, 634)
            time.sleep(1)
            m.click(1200, 838)
            time.sleep(1)
            d.find_element_by_xpath('//*[@id="td1_ATTACHMENT"]/div/div[3]/div[2]/a').click()  # 点击upload

            d.find_element_by_xpath('//*[@id="td2_ATTACHMENT"]/div/div[3]/div[2]/div').click()
            time.sleep(1)
            m.click(1000, 634)
            time.sleep(1)
            m.click(1200, 838)
            time.sleep(1)
            d.find_element_by_xpath('//*[@id="td2_ATTACHMENT"]/div/div[3]/div[2]/a').click()  # 点击upload

            d.find_element_by_xpath('//*[@id="td3_ATTACHMENT"]/div/div[3]/div[2]/div').click()
            time.sleep(1)
            m.click(1000, 634)
            time.sleep(1)
            m.click(1200, 838)
            time.sleep(1)
            d.find_element_by_xpath('//*[@id="td3_ATTACHMENT"]/div/div[3]/div[2]/a').click()  # 点击upload
            time.sleep(1)
            ...
            d.find_element_by_xpath('//*[@id="myTab"]/li[2]').click()  # 点击todaylist
