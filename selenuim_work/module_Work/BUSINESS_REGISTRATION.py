...
def beian_shenpi(d):
    ...
    d.execute_script("document.getElementById('C_ESTABLISHMENT').value = '%sFEB2024'" % random.randint(1, 28))

    for i in range(1, 7):
        try:
            d.find_element_by_xpath('//*[@id="table_C"]/tbody/tr[%s]/td[4]/a' % i).click()  # 点击上传文件
            ...
            time.sleep(1)
            try:
                d.execute_script("document.getElementById('START_TIME_%s').value = '%sFEB2024'" % (i, random.randint(1, 28)))
                d.execute_script("document.getElementById('END_TIME_%s').value = '%sMAR2025'" % (i, random.randint(1, 28)))
            except:pass
        except: break
    ...
    d.find_element_by_id('L_NAME').send_keys('bdj')  # 输入法人信息
    ...
    d.find_element_by_id('A_OWNER').send_keys('李大牛')
    ...
    for i in range(1, 8):
        try:
            d.find_element_by_xpath('//*[@id="table_A"]/tbody/tr[%s]/td[4]/a' % i).click()  # 点击上传文件
            ...
            time.sleep(1)
            d.execute_script(
                "document.getElementById('START_TIME_%s').value = '%sFEB2024'" % (i + 9, random.randint(1, 28)))
            d.execute_script(
                "document.getElementById('END_TIME_%s').value = '%sMAR2025'" % (i + 9, random.randint(1, 28)))
        except:pass
        try:
    ...
    try:d.find_element_by_xpath('//*[@id="sbld"]').click()  # 点击logout
    except:pass
