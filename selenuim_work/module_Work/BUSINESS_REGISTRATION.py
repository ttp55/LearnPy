...
def new_information(d):
    ...
    d.find_element_by_id('P_INFO_SAVE')  # 点击保存
    ...
    d.find_element_by_xpath('//*[@id="C_NAME_CH"]').send_keys('不是我不明白')  # 输入公司名称
    ...
    d.find_element_by_xpath('//*[@id="P_NAME"]').send_keys('bdjbdj')  # 输入填报人信息
    ...
    d.find_element_by_xpath('//*[@id="P_POSITION"]').send_keys('内蒙古')
    ...
    d.find_element_by_xpath('//*[@id="L_NAME"]').send_keys('bdjbdj')  # 输入法人信息
    ...
    d.find_element_by_xpath('//*[@id="L_POSITION"]').send_keys('内蒙古')
